...
<div class="container" style="<?php echo $nofood;?>">
    ...
    <div class="addressbox" id="address_<?php echo $address['address_id'];?>" addr_id="<?php echo $address['address_id'];?>">
        ...
        <br/>
        <br/>
        <span id="phone_<?php echo $address['address_id'];?>" ><?php echo $address['phone'];?></span><span style="float: right;margin-top: -30px" class="mark"><img src="catalog/view/theme/default/image/icons/marked.png"></span>
    </div>
    <?php } ?>
