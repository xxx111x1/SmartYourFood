...
<div class="container" style="opacity: 1.0">
    ...
    <div class="cart_panel">
        <div class="cart_header">
            ...
            <div class="confirmlabel"><?php echo $Order_Succeed; ?></div>
            <div class="gobackcart"><a href="/index.php?route=common/list&restaurant=1" style="text-decoration: none;color: #555555;float:right;margin-right: 40px;"><?php echo $Order_More; ?></a></div>
        </div>
        ...
        <div id="cost_summary" style="border-bottom-color:grey;border-top-color: grey">
   ...
   <?php echo $Delivery_Information; ?>
    ...
    <div class="addressarea" style="height: 200px;">
        <?php if($validaddress){ ?>
        <div class="addressbox" style="border-style: solid;border-color: grey;border-width: 1px;">
