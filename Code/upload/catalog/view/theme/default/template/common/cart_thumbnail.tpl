<div class="cart_dropdown" id="cart_dropdown">
    ...
    <?php if ($products) { ?>
      ...
      <table class="cart-thumbnail-table">
        ...
        <tr class="food-row">
          <td class="cart-food-name" ><div class="food-name-detail" title="<?php if($lang ==  'en'){echo $product['name_en'];} else {echo $product['name'];} ?>" href="<?php echo $product['href']; ?>"><?php if($lang ==  'en'){echo $product['name_en'];} else {echo $product['name'];} ?></div></td>
