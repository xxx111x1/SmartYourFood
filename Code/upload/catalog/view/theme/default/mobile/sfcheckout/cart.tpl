...
<div class="sub_header col-1-1">
	...
	<div class="col-7-12 sub_header_title">        	
        <div id="header_title"><?php echo $Order;?></div>
 	</div>
</div>
...
<div class="address_area">
	...
	<div class="col-9-12" style="float:left;">
		<div class="address_info">
			<div class="address_contact"><?php echo $addr['contact'];?> <?php echo $addr['phone'];?></div>
			<div class="address overflow" title="<?php echo $addr['address'];?>"><?php echo $addr['address'];?></div>
		</div>
	</div>
...
<div class="payment_area">
	...
	<div class="payment_method">
        ...
        <!--<input class="payment_selection" type="checkbox" id="by_chash" checked />-->     
    </div>
...
<div class="footer col-1-1">
  <div class="detail_navigation">
  	...
  	<div class="detail_navigation_item" style="float:right;margin-right: 20px;">
  		<a class="cart_navigation_label navigation_frame" id="orderConfirm" href="/index.php?route=sfcheckout/confirm&isFast=true">
        	<div class="cart_navigation_label navigation_frame" style="margin-top: 5px;height: 40px; line-height: 40px;margin-right: 20px;width: 100%;background: #f65053; text-align: center; color: white;-moz-border-radius: 9px; -webkit-border-radius: 9px; border-radius: 9px;"><?php echo $Pay_Bill?></div>
    	</a>    		
  	</div>
  </div>      
</div>
