...
//start to debug
		$this->log->write("' store_id = '" . (int)$data['store_id'] );
		$this->log->write("' store_name = '" . $this->db->escape($data['store_name']) );
		$this->log->write("' store_url = '" . $this->db->escape($data['store_url']) );
		$this->log->write("' customer_id = '" . (int)$data['customer_id'] );
		$this->log->write("' customer_group_id = '" . (int)$data['customer_group_id'] );
		$this->log->write("' firstname = '" . $this->db->escape($data['firstname']) );
		$this->log->write("' lastname = '" . $this->db->escape($data['lastname']) );
		$this->log->write("' email = '" . $this->db->escape($data['email']) );
		$this->log->write("' telephone = '" . $this->db->escape($data['telephone']) );
		$this->log->write("' fax = '" . $this->db->escape($data['fax']) );
		$this->log->write("' custom_field = '" . $this->db->escape(isset($data['custom_field']) ? serialize($data['custom_field']) : '') );
		$this->log->write("' payment_firstname = '" . $this->db->escape($data['payment_firstname']) );
		$this->log->write("' payment_lastname = '" . $this->db->escape($data['payment_lastname']) );
		$this->log->write("' payment_company = '" . $this->db->escape($data['payment_company']) );
		$this->log->write("' payment_address_1 = '" . $this->db->escape($data['payment_address_1']) );
		$this->log->write("' payment_address_2 = '" . $this->db->escape($data['payment_address_2']) );
		$this->log->write("' payment_city = '" . $this->db->escape($data['payment_city']) );
		$this->log->write("' payment_postcode = '" . $this->db->escape($data['payment_postcode']) );
		$this->log->write("' payment_country = '" . $this->db->escape($data['payment_country']) );
		$this->log->write("' payment_country_id = '" . (int)$data['payment_country_id'] );
		$this->log->write("' payment_zone = '" . $this->db->escape($data['payment_zone']) );
		$this->log->write("' payment_zone_id = '" . (int)$data['payment_zone_id'] );
		$this->log->write("' payment_address_format = '" . $this->db->escape($data['payment_address_format']) );
		$this->log->write("' payment_custom_field = '" . $this->db->escape(isset($data['payment_custom_field']) ? serialize($data['payment_custom_field']) : '') );
		$this->log->write("' payment_method = '" . $this->db->escape($data['payment_method']) );
		$this->log->write("' payment_code = '" . $this->db->escape($data['payment_code']) );
		$this->log->write("' shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) );
		$this->log->write("' shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) );
		$this->log->write("' shipping_company = '" . $this->db->escape($data['shipping_company']) );
		$this->log->write("' shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) );
		$this->log->write("' shipping_address_2 = '" . $this->db->escape($data['shipping_address_2']) );
		$this->log->write("' shipping_city = '" . $this->db->escape($data['shipping_city']) );
		$this->log->write("' shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) );
		$this->log->write("' shipping_country = '" . $this->db->escape($data['shipping_country']) );
		$this->log->write("' shipping_country_id = '" . (int)$data['shipping_country_id'] );
		$this->log->write("' shipping_zone = '" . $this->db->escape($data['shipping_zone']) );
		$this->log->write("' shipping_zone_id = '" . (int)$data['shipping_zone_id'] );
		$this->log->write("' shipping_address_format = '" . $this->db->escape($data['shipping_address_format']) );
		$this->log->write("' shipping_custom_field = '" . $this->db->escape(isset($data['shipping_custom_field']) ? serialize($data['shipping_custom_field']) : '') );
		$this->log->write("' shipping_method = '" . $this->db->escape($data['shipping_method']) );
		$this->log->write("' shipping_code = '" . $this->db->escape($data['shipping_code']) );
		$this->log->write("' comment = '" . $this->db->escape($data['comment']) );
		$this->log->write("' total = '" . (float)$data['total'] );
		$this->log->write("' affiliate_id = '" . (int)$data['affiliate_id'] );
		$this->log->write("' commission = '" . (float)$data['commission'] );
		$this->log->write("' marketing_id = '" . (int)$data['marketing_id'] );
		$this->log->write("' tracking = '" . $this->db->escape($data['tracking']) );
		$this->log->write("' language_id = '" . (int)$data['language_id'] );
		$this->log->write("' currency_id = '" . (int)$data['currency_id'] );
		$this->log->write("' currency_code = '" . $this->db->escape($data['currency_code']) );
		$this->log->write("' currency_value = '" . (float)$data['currency_value'] );
		$this->log->write("' ip = '" . $this->db->escape($data['ip']) );
		$this->log->write("' forwarded_ip = '" .  $this->db->escape($data['forwarded_ip']) );
		$this->log->write("' user_agent = '" . $this->db->escape($data['user_agent']) );
		$this->log->write("' accept_language = '" . $this->db->escape($data['accept_language']) );
		//end debug
		$this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET invoice_prefix = '" . $this->db->escape($data['invoice_prefix']) . "', store_id = '" . (int)$data['store_id'] . "', store_name = '" . $this->db->escape($data['store_name']) . "', store_address = '" . $this->db->escape($data['store_address']) . "', store_telephone = '" . $this->db->escape($data['store_telephone']) . "', store_url = '" . $this->db->escape($data['store_url']) . "', customer_id = '" . (int)$data['customer_id'] . "', customer_group_id = '" . (int)$data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? serialize($data['custom_field']) : '') . "', payment_firstname = '" . $this->db->escape($data['payment_firstname']) . "', payment_lastname = '" . $this->db->escape($data['payment_lastname']) . "', payment_company = '" . $this->db->escape($data['payment_company']) . "', payment_address_1 = '" . $this->db->escape($data['payment_address_1']) . "', payment_address_2 = '" . $this->db->escape($data['payment_address_2']) . "', payment_city = '" . $this->db->escape($data['payment_city']) . "', payment_postcode = '" . $this->db->escape($data['payment_postcode']) . "', payment_country = '" . $this->db->escape($data['payment_country']) . "', payment_country_id = '" . (int)$data['payment_country_id'] . "', payment_zone = '" . $this->db->escape($data['payment_zone']) . "', payment_zone_id = '" . (int)$data['payment_zone_id'] . "', payment_address_format = '" . $this->db->escape($data['payment_address_format']) . "', payment_custom_field = '" . $this->db->escape(isset($data['payment_custom_field']) ? serialize($data['payment_custom_field']) : '') . "', payment_method = '" . $this->db->escape($data['payment_method']) . "', payment_code = '" . $this->db->escape($data['payment_code']) . "', shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) . "', shipping_company = '" . $this->db->escape($data['shipping_company']) . "', shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) . "', shipping_address_2 = '" . $this->db->escape($data['shipping_address_2']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', shipping_country = '" . $this->db->escape($data['shipping_country']) . "', shipping_country_id = '" . (int)$data['shipping_country_id'] . "', shipping_zone = '" . $this->db->escape($data['shipping_zone']) . "', shipping_zone_id = '" . (int)$data['shipping_zone_id'] . "', shipping_address_format = '" . $this->db->escape($data['shipping_address_format']) . "', shipping_custom_field = '" . $this->db->escape(isset($data['shipping_custom_field']) ? serialize($data['shipping_custom_field']) : '') . "', shipping_method = '" . $this->db->escape($data['shipping_method']) . "', shipping_code = '" . $this->db->escape($data['shipping_code']) . "', comment = '" . $this->db->escape($data['comment']) . "', total = '" . (float)$data['total'] ."', deliverfee= '" . (float)$data['deliverfee'] ."', extra_cost= '" . (float)$data['extra_cost'] . "', affiliate_id = '" . (int)$data['affiliate_id'] . "', commission = '" . (float)$data['commission'] . "', marketing_id = '" . (int)$data['marketing_id'] . "', tracking = '" . $this->db->escape($data['tracking']) . "', language_id = '" . (int)$data['language_id'] . "', currency_id = '" . (int)$data['currency_id'] . "', currency_code = '" . $this->db->escape($data['currency_code']) . "', currency_value = '" . (float)$data['currency_value'] . "', ip = '" . $this->db->escape($data['ip']) . "', forwarded_ip = '" .  $this->db->escape($data['forwarded_ip']) . "', user_agent = '" . $this->db->escape($data['user_agent']) . "', accept_language = '" . $this->db->escape($data['accept_language']) . "', date_added = NOW(), date_modified = NOW()");
	...
	public function notifyAdmin($orderid)
	{
        ...
        foreach($query_res->rows as $order)
        {
            $this->notifyDetail2Admin($order);
        }
	}


	public function notifyDetail2Admin($order_detail)
	{
        ...
        $msg = 'OrderID: '.$order_detail['order_id'].
            ...
            'RestTelephone: '.$order_detail['store_telephone'].
            'CustomerAddress: '.$order_detail['shipping_address_1'].' '.$order_detail['shipping_address_2'].
            'CustomerName: '.$order_detail['shipping_firstname'].
            'CustomerTelephone: '.$order_detail['telephone'].
