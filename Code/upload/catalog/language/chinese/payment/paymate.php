...
$_['text_failed_message']		= '<p>Unfortunately there was an error processing your Paymate transaction.</p><p><b>警告: </b>%s</p><p>Please verify your Paymate account balance before attempting to re-process this order</p><p> If you believe this transaction has completed successfully, or is showing as a deduction in your Paymate account, please <a href="%s">Contact Us</a> with your order details.</p>';
