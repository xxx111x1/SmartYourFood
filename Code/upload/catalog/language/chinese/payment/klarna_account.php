...
**/
// Text
$_['text_title']				= 'Klarna 账户 - Pay from %s/month';
$_['text_terms']				= '<span id="klarna_account_toc"></span><script type="text/javascript">var terms = new Klarna.Terms.账户({el: \'klarna_account_toc\', eid: \'%s\', country: \'%s\'});</script>';
$_['text_information']			= 'Klarna 账户 Information';
$_['text_additional']			= 'Klarna 账户 requires some additional information before they can proccess your order.';
$_['text_male']					= 'Male';
...
$_['entry_company']				= '公司 Registration Number';
...
$_['help_company']				= 'Please enter your 公司\'s registration number';
